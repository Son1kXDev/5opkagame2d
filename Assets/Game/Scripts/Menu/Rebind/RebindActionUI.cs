    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (action.bindings[bindingIndex].isPartOfComposite)
                partName = $"Назначение '{action.bindings[bindingIndex].name}'. ";
            ...
            if (m_RebindText != null)
            {
                var text = !string.IsNullOrEmpty(m_RebindOperation.expectedControlType)
                    ? $"{partName}Ожидание ввода для {m_RebindOperation.expectedControlType}..."
                    : $"{partName}Ожидание ввода...";
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Duplicate binding found: " + newBinding.effectivePath, this);
                    return true;
                }
            }
            if (allCompositeParts)
